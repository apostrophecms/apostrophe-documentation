...
A `joinByOneReverse` field allows us to access the other side of a [joinByOne](/reference/field-types/joinByOne) relationship. Since this is the "other end" of the relationship, there is no editing interface. It is just a convenience allowing us to "see" the related object from the other point of view.
