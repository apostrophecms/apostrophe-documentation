...
`addFieldType` calls the [addFieldType method of the `apostrophe-schemas` module](/api/apostrophe-schemas/README.md#addfieldtype-type) to add a new schema field type to Apostrophe.
