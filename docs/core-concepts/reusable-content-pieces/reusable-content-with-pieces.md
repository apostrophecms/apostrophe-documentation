...
::: tip
There are many other methods you can override or extend to change the behavior of pieces. See [the apostrophe-pieces API methods](/api/apostrophe-pieces/README.md) for more information.
:::
