...
### enablePrefix\(_prefix_\)

If Apostrophe has a global URL prefix, patch jQuery's AJAX capabilities to prepend that prefix to any non-absolute URL. This assists in avoiding the need for application code to be specifically prefix-aware and allows the prefix to be changed whenever needed. See also [apostrophe-express](https://github.com/apostrophecms/apostrophe-documentation/tree/e71017392b54a258d8d72811456c862139150a96/modules/apostrophe-express/index.html)
...
Do not call this method yourself. It is called by self.globalBusy to display the global spinner. Freel free to override this method to change the UI.

### globalUnlock\(\)

Do not call this method yourself. It is called by self.globalBusy to hide the global spinner. Freel free to override this method to change the UI.
...
### link\(_sel_, _verb_, _object_, _callback_\)
...
### ajaxSubmitHandler\(_event_\)

### ajaxClickHandler\(_event_\)
...
### ajaxGo\(_name_, _url_, _data_, _options_\)
...
### replaceUnpreserved\(_$old_, _$new_, _options_\)
