---
title: More Navigation Examples
layout: tutorial
---

# More Navigation Examples

The following goes into more detail with examples of different styles of navigation that you can use in your template, and additional ways to access ancestor and child pages.
...
A common navigation design is to have a row of "tabs" at the top. Want to display those no matter where in the site you are? Add this to your template:
...
Now you can easily output all the markup you'd need for dropdown menus. Add this code to your template:
