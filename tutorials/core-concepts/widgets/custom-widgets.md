---
title: More Navigation Widgets
layout: tutorial
---

# More Navigation Widgets
...
The [`link` widget](widgets-example.md) is cool, but if the URL of a page changes, the link breaks. And if the title changes, that is not reflected in the widget.
