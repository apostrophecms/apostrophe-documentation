...
Sites running in a [multicore](../howtos/multicore.md) configuration will require additional RAM and, of course, CPU cores.
...
> You can skip most of these steps and set up a Linux server with Stagecoach, ready to deploy, with hardly any effort if you use our [Linode stackscript](https://www.linode.com/stackscripts/view/239217-punkave-Apostrophe+CMS). For more information check out our [Linode HOWTO](../howtos/linode.md).
