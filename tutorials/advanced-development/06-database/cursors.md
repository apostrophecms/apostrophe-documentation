...
> See [reusable content with pieces](/tutorials/core-concepts/03-reusable-content-pieces/reusable-content-with-pieces.md) for a more complete discussion of this particular example join.
