...
Most of the time, you should [use Apostrophe's model layer](/tutorials/advanced-development/06-database/model-layer.md) to access Apostrophe's content. That gives you the benefit of permissions, sensible default sorting orders, widget loaders, joins... so, so many good things.
