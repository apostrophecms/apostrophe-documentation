...
That's it! Really. And it automatically works with the filters from the [Connecting Piece Types example](/tutorials/core-concepts/03-reusable-content-pieces/children-and-joins.md).
