...
The `limit` property on array fields will limit the number of items an editor can add to the array. So if you set `limit: 3`, they can only one to three items in that array.
