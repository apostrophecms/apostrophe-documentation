...
The [apostrophe-schemas](https://github.com/apostrophecms/apostrophe-documentation/tree/75c44ebf643c2311c37ac7d95760172bdfad13d1/modules/apostrophe-schemas/index.md) module provides powerful tools for working with schemas, but 99% of the time we use them automatically by extending [apostrophe-pieces](https://github.com/apostrophecms/apostrophe-documentation/tree/75c44ebf643c2311c37ac7d95760172bdfad13d1/modules/apostrophe-pieces/index.md), [apostrophe-widgets](https://github.com/apostrophecms/apostrophe-documentation/tree/75c44ebf643c2311c37ac7d95760172bdfad13d1/modules/apostrophe-widgets/index.md) or [apostrophe-custom-pages](https://github.com/apostrophecms/apostrophe-documentation/tree/75c44ebf643c2311c37ac7d95760172bdfad13d1/modules/apostrophe-custom-pages/index.md). They can also be used directly in custom projects.

### Building schemas with `addFields` and friends

Modules like [apostrophe-pieces](https://github.com/apostrophecms/apostrophe-documentation/tree/75c44ebf643c2311c37ac7d95760172bdfad13d1/modules/apostrophe-pieces/index.md) pass on their `addFields`, `removeFields`, `alterFields` and `arrangeFields` options to the `compose` method of [apostrophe-schemas\#compose](https://github.com/apostrophecms/apostrophe-documentation/tree/75c44ebf643c2311c37ac7d95760172bdfad13d1/modules/apostrophe-schemas/index.md). And the beautiful thing about `compose` is how easy it becomes to create the schema you want, adding fields here, removing fields there and arranging them into tabs to suit your needs.
...
When you create a new module that extends [apostrophe-pieces](https://github.com/apostrophecms/apostrophe-documentation/tree/75c44ebf643c2311c37ac7d95760172bdfad13d1/modules/apostrophe-pieces/index.md) at the project level, you will often use these options directly.
...
`attachment` fields can be limited to a particular file type group by setting the `group` option to either `images` or `office`. Other groups can be configured via the `fileGroups` option of the [apostrophe-attachments](https://github.com/apostrophecms/apostrophe-documentation/tree/75c44ebf643c2311c37ac7d95760172bdfad13d1/modules/apostrophe-attachments/index.md) module.

Attachments are most often used indirectly via [apostrophe-images-widgets](https://github.com/apostrophecms/apostrophe-documentation/tree/75c44ebf643c2311c37ac7d95760172bdfad13d1/modules/apostrophe-images-widgets/index.md) or [apostrophe-files-widgets](https://github.com/apostrophecms/apostrophe-documentation/tree/75c44ebf643c2311c37ac7d95760172bdfad13d1/modules/apostrophe-files-widgets/index.md), which are backed by the [apostrophe-images](https://github.com/apostrophecms/apostrophe-documentation/tree/75c44ebf643c2311c37ac7d95760172bdfad13d1/modules/apostrophe-images/README.md) and [apostrophe-files](https://github.com/apostrophecms/apostrophe-documentation/tree/75c44ebf643c2311c37ac7d95760172bdfad13d1/modules/apostrophe-files/README.md) subclasses of pieces. Each of those piece types contains an attachment field and some metadata fields, making them a convenient way to reuse files.
...
A `video` field allows the user to embed video hosted by any [oembed](http://oembed.com/)—compatible video hosting site, or any site for which you have provided an [oembetter](https://github.com/punkave/oembetter) filter via the [apostrophe-oembed](https://github.com/apostrophecms/apostrophe-documentation/tree/75c44ebf643c2311c37ac7d95760172bdfad13d1/modules/apostrophe-oembed/index.md) module.
...
[apostrophe-oembed](https://github.com/apostrophecms/apostrophe-documentation/tree/75c44ebf643c2311c37ac7d95760172bdfad13d1/modules/apostrophe-oembed/index.md) provides browser-side methods to display the video. See the [apostrophe-video-widgets](https://github.com/apostrophecms/apostrophe-documentation/tree/75c44ebf643c2311c37ac7d95760172bdfad13d1/modules/apostrophe-video-widgets/index.md) source code for an example of using these methods to play a video in a `div` element.
