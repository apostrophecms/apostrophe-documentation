...
> There are many other methods you can override or extend to change the behavior of pieces. See [the apostrophe-pieces API methods](../../reference/apostrophe-pieces/index.html) for more information.
