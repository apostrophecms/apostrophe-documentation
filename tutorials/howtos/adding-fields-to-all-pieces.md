...
As explained in the tutorials, the [apostrophe-pieces](https://github.com/apostrophecms/apostrophe-documentation/tree/e71017392b54a258d8d72811456c862139150a96/modules/apostrophe-pieces/index.html) module is a great way to create reusable content that appears all over the site — both on [apostrophe-pieces-pages](https://github.com/apostrophecms/apostrophe-documentation/tree/e71017392b54a258d8d72811456c862139150a96/modules/apostrophe-pieces-pages/index.html) and in [apostrophe-pieces-widgets](https://github.com/apostrophecms/apostrophe-documentation/tree/e71017392b54a258d8d72811456c862139150a96/modules/apostrophe-pieces-widgets/index.html).
...
_Any configuration we set for_ `apostrophe-pieces` _becomes part of the configuration for all of the modules that extend it._
...
So instead, we'll write a `beforeConstruct` function in `lib/modules/apostrophe-pieces/index.js`. The great thing about `beforeConstruct` is that it is _called for the subclasses first_. That means that by the time it is called for us, _all the fields for the subclass are already in_ `addFields`. We can simply prepend our own:
